...
class SimpleSamplerWrapRectangle::ThisPrivate{
public:
    SimpleSamplerWrapRectangle * super ;
    ThisPrivate(SimpleSamplerWrapRectangle * s):super(s){
}
/****************************************************/
/****************************************************/
...
SimpleSamplerWrapRectangle::SimpleSamplerWrapRectangle(QWidget * p):
...
SimpleSamplerWrapRectangle::~SimpleSamplerWrapRectangle(){
    delete thisp;
}

void SimpleSamplerWrapRectangle::initializeGL(){
...
void SimpleSamplerWrapRectangle::paintGL(){
if(0==thisp){return;}
if (isOpenGLPainting) { return; }
typedef void(*PaintStateDeleteFunction)(SimpleSamplerWrapRectangle *);
std::unique_ptr<SimpleSamplerWrapRectangle, PaintStateDeleteFunction>
paintState(this, [](SimpleSamplerWrapRectangle * this__) {this__->isOpenGLPainting = false; });
isOpenGLPainting = true;
{
    thisp->paintGL();
}
}
void SimpleSamplerWrapRectangle::resizeGL(int w,int h){
    thisp->resizeGL(w,h);
}
