...
template<typename T>
class FlipYCallBack : public T{
public:
    virtual void findTexture(int a0, float a1, float a2, int a3) override {
        T::findTexture(a0,a1,1-a2,a3);
    }
};
...
void eval_command(const Command & command_){
    ...
    case Vertex:{
        callBack = new gl::VertexElementCallBack;
    }
        break;
    case Vertex|Normal:{
        callBack = new gl::VertexNormalElementCallBack;
    }
        break;
    case Vertex|Normal|Texture:{
        callBack =\
                new FlipYCallBack<gl::VertexTextureNormalElementCallBack>;
    }
        break;
    default:
        break;
